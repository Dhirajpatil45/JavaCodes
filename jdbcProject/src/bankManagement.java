...
//                                    "Err : Enter Valid input!\n"); 
        ...
        public static boolean depositeMoney(int sender_ac,int amount) 
			throws SQLException  
			{ 
			// validation 
			if (amount == NULL) { 
        ...
        public static boolean withdrawMoney(int sender_ac,int amount) 
    			throws SQLException  
    			{ 
    			// validation 
    			if (amount == NULL) { 
        ...
        public static void 
        deleteAccount(int acNo) // fetch balance method 
        { 
            try { 
      
                // query 
                sql = "delete from customer where ac_no=" 
                      + acNo; 
                PreparedStatement st 
                    = con.prepareStatement(sql); 
                ...
                System.out.println( 
                    "-----------------------------------------------------------"); 
                System.out.printf("Your account has been deleted sucessfully....\n"); 
